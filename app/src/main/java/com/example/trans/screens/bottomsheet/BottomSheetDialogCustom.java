 ...
 */
public class BottomSheetDialogCustom extends AppCompatDialog {
    ...
    public BottomSheetDialogCustom(@NonNull Context context) {
        this(context, 0);
    ...
    public BottomSheetDialogCustom(@NonNull Context context, @StyleRes int theme) {
        ...
        if (container == null) {
            container =
                    (FrameLayout) View.inflate(getContext(),
                            com.example.trans.R.layout.design_bottom_sheet_dialog_custom, null);
    ...
    private static class EdgeToEdgeCallback extends BottomSheetBehavior.BottomSheetCallback {
        ...
        private void setPaddingForPosition(View bottomSheet) {
            if (bottomSheet.getTop() < insetsCompat.getSystemWindowInsetTop()) {
                ...
                if (window != null) {
                    EdgeToEdgeUtilsV2.setLightStatusBar(
                ...
                // status bar.
                if (window != null) {
                    EdgeToEdgeUtilsV2.setLightStatusBar(window, lightStatusBar);
                }
                bottomSheet.setPadding(
                        bottomSheet.getPaddingLeft(),
                        0,
